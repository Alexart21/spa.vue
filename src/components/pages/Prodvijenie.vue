<template>
  <article>
    <img width="250" height="144" class="resp_img" src="./../../assets/img/main_img/seo.jpg" alt="продвижение сайтов"
    ...
    <h2 id="base_seo" class="header_shadow">Продвижение сайта, необходимый минимум и с чего начинается раскрутка
      сайта</h2>
    <h3>Продвижение сайта и базовая <abbr
        title="англ. search engine optimization — комплекс мер по внутренней и внешней оптимизации, для поднятия позиций сайта в результатах выдачи поисковых систем">SEO</abbr><sup
        class="prim">*</sup> оптимизация</h3>
    <p>
    ...
    <p>
      ...
      стандартам консорциума <abbr
        title="англ. World Wide Web Consortium, W3C — организация, разрабатывающая и внедряющая технологические стандарты для Всемирной паутины">W3C.</abbr><sup
        class="prim">**</sup>
    </p>
    <p>
    ...
    <p>
      ...
      <em>
        <abbr
            title="англ. search engine optimization — комплекс мер по внутренней и внешней оптимизации, для поднятия позиций сайта в результатах выдачи поисковых систем"><b>SEO</b></abbr>
        (search engine optimization) — оптимизация для поисковых машин, в народном фольклоре
        продвижение или раскрутка сайта.<br>
        <abbr
            title="англ. World Wide Web Consortium, W3C — организация, разрабатывающая и внедряющая технологические стандарты для Всемирной паутины"><b>W3C</b></abbr>
  ...
  <article>
    ...
    <p>
      ...
      Ведь вполне может быть что именно для Вашего сайта эффективней окажется не <strong><abbr
        title="англ. search engine optimization — комплекс мер по внутренней и внешней оптимизации, для поднятия позиций сайта в результатах выдачи поисковых систем">SEO</abbr>
  ...
  <article>
    ...
    <figure class="kontext_img">
      <img width="400" height="382" class="resp_img" src="./../../assets/img/main_img/yandex.jpg"
           alt="контекстная реклама на Яндекс" title="контекстная реклама на Яндекс">
      <figcaption class="strong_text">Так может выглядеть реклама на Яндекс</figcaption>
    </figure>
    <figure class="kontext_img">
      <img width="400" height="382" class="resp_img" src="./../../assets/img/main_img/google.jpg"
           alt="контекстная реклама на Google" title="контекстная реклама на Google">
    ...
    <p>
      ...
      прекращения <abbr
        title="англ. search engine optimization — комплекс мер по внутренней и внешней оптимизации, для поднятия позиций сайта в результатах выдачи поисковых систем">SEO</abbr>
      продвижения висел в топе еще 2 года.<br> Поэтому наша рекомендация — применяйте
