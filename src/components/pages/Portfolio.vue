<template>
  <div class="h2 header_shadow text-center">Наши работы</div>
  <br/>
  <div id="portf" class="min_height">
    ...
    <div class="atv-outer">
      ...
      <a href="http://houme21.ru" target="_blank">
        <figure class="a-image atvImg">
          ...
          <img class="atvImg-layer" data-img="./../../assets/img/main_img/portfolio/img1.jpg"
    ...
    <div class="atv-outer">
      ...
      <a href="http://s-solo.ru" target="_blank">
        <figure class="a-image atvImg">
          <div class="atvImg-shadow"></div>
          <img class="atvImg-layer" data-img="./../../assets/img/main_img/portfolio/img2.jpg"
  ...
  methods: {
    atvImg() {
      function e(e, t, a, r, s, o) {
        var i = n.scrollTop || l.scrollTop, d = n.scrollLeft, c = t ? e.touches[0].pageX : e.pageX,
            m = t ? e.touches[0].pageY : e.pageY, v = a.getBoundingClientRect(),
            f = a.clientWidth || a.offsetWidth || a.scrollWidth, g = a.clientHeight || a.offsetHeight || a.scrollHeight,
            h = 320 / f, u = .52 - (c - v.left - d) / f, p = .52 - (m - v.top - i) / g, y = m - v.top - i - g / 2,
            E = c - v.left - d - f / 2, C = .07 * (u - E) * h, I = .1 * (y - p) * h,
            N = "rotateX(" + I + "deg) rotateY(" + C + "deg)", x = Math.atan2(y, E), b = 180 * x / Math.PI - 90;
      ...
      var r = document, n = (r.documentElement, r.getElementsByTagName("body")[0]),
          l = r.getElementsByTagName("html")[0], s = window, o = r.querySelectorAll(".atvImg"), i = o.length,
      ...
      if (!(0 >= i)) for (var c = 0; i > c; c++) {
        ...
        if (!(0 >= f)) {
          ...
          var g = r.createElement("div"), h = r.createElement("div"), u = r.createElement("div"),
              p = r.createElement("div"), y = [];
          ...
          for (var E = 0; f > E; E++) {
            ...
            C.className = "atvImg-rendered-layer", C.setAttribute("data-layer", E), C.style.backgroundImage = "url(" + require('@/assets/img/main_img/portfolio/img' + String(c + 1) + '.jpg') + ")", p.appendChild(C), y.push(C)
          }
