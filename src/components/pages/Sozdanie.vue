  ...
  <article>
    ...
    <p>
      <img width="250" height="171" class="resp_img no_shadow no_border align-left img-outs2"
           src="./../../assets/img/main_img/vizitka.png" alt="сайт визитка" title="сайт визитка">
    ...
    <p>
      <img width="250" height="136" class="resp_img no_border no_shadow align-left img-outs3"
           src="./../../assets/img/main_img/corp.png" alt="корпоративный сайт" title="корпоративный сайт">
    ...
    <p>
      <img width="250" height="209" class="resp_img no_border no_shadow align-left"
           src="./../../assets/img/main_img/market.jpg"
    ...
    <div>
      <img width="250" height="208" class="resp_img no_border no_shadow align-left img-outs4"
           src="./../../assets/img/main_img/response.png"
