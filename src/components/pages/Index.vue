      ...
      <div id="s1">
        <div class="site_block">
          ...
          <a href="/#contacts" title="заказать сайт визитку" class="zayavka link-anim"><span
              class="fab fa-telegram-plane no-sh"></span> заказать сайт визитку</a>
        </div>
      </div>
      <div id="s2">
        <div class="site_block">
          ...
          <a href="/#contacts" title="заказать корпоративный сайт" class="zayavka link-anim"><span
              class="fab fa-telegram-plane no-sh"></span> заказать корпоративный сайт</a>
        </div>
      </div>
      <div id="s3">
        <div class="site_block">
          ...
          <a href="/#contacts" title="заказать интернет магазин" class="zayavka link-anim"><span
              class="fab fa-telegram-plane no-sh"></span> заказать интернет магазин</a>
        </div>
      </div>
    </div>
    <div id="bonus">
